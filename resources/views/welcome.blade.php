...
<div class="container mx-auto mt-5 mb-24 text-center ">
    <div class="justify-items-center">
        <h1 class="inline-block text-center border-b-2 border-red-900"> Coming soon </h1>
    </div>
    <div class="container grid grid-cols-1 gap-4 mx-auto mt-10 md:grid-cols-5">
        <div class="col-span-5 overflow-x-hidden">
            <div class="swiper-five">
                <div class="swiper-wrapper">
                    <div class="items-center text-center bg-no-repeat bg-cover border h-96 swiper-slide" style="background-image: url()">
                        <img src="#" alt="" class="w-full h-36">
                        <p class="items-end block w-full h-24 truncate bg-white">
                            hello World
                        </p>   
...
var swiper1 = new Swiper('.swiper-con', {
  ...
  breakpoints: {
    ...
    var swiper2 = new Swiper('.swiper-five', {
      spaceBetween:2,
      slidesPerView: 2,
      direction: getDirection(),
      navigation: {
